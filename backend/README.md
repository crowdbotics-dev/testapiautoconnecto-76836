...
## Project Structure
    ...
    ├── testapiautoconnecto_76836  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_76836`
...
2. Clone this repo and `cd testapiautoconnecto_76836`
